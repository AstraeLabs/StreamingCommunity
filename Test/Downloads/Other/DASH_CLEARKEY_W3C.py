...
# (demo/common/assets.js) — unlike the Axinom vector in DASH_CLEARKEY.py, this
# manifest's ContentProtection actually signals urn:uuid:1077efec-... (org.w3.clearkey),
mpd_url = "https://storage.googleapis.com/shaka-demo-assets/angel-one-clearkey/dash.mpd"
mpd_headers = {}
license_url = ""
license_headers = {}

# cwip-shaka-proxy's "license server" is just kid=key echoed back in the URL query
# string (https://cwip-shaka-proxy.appspot.com/clearkey?_u3wDe7erb7v8Lqt8A3QDQ=ABEiM0RVZneImaq7zN3u_w),
# base64url -> hex: kid feedf00deedeadbeeff0baadf00dd00d (matches the manifest's
...
dash_process = DASH_Downloader(
    ...
    output_path=rf".\Video\DASH_CLEARKEY_W3C.{conf_extension}",
    key=license_key,
